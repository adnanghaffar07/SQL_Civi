...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://root:jhon@Doe123@127.0.0.1/civicrmTest?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://root:jhon@Doe123@127.0.0.1/civicrmTest_civicrm?new_link=true');
}
...
$civicrm_root = '/home/webserver/civicrmTest/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home/webserver/civicrmTest/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://127.0.0.1:8001/civicrmTest/');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', '3d25deecd987482025af96a3412aa717');
}
...
// define( 'CIVICRM_MAIL_LOG', '/home/webserver/civicrmTest/sites/default/files/civicrm/templates_c//mail.log');
// }
